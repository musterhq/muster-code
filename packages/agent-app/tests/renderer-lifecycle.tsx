...
eventListener({type:'timelinePatch',chatId:'a',patch:{after:1,revision:2,items:[{id:'a1',chatId:'a',kind:'assistant',text:'Chat a live update',createdAt:''}]}});
await delay(60);
...
eventListener({type:'timelinePatch',chatId:'a',patch:{after:0,revision:1,items:[{id:'a1',chatId:'a',kind:'assistant',text:'obsolete',createdAt:''}]}});
await delay(30);
...
assert.equal(tableRoot.querySelector('[data-selected="true"]'),null);
